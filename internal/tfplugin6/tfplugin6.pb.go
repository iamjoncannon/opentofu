...
type GetPlatformConfiguration struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetPlatformConfiguration) Reset() {
	*x = GetPlatformConfiguration{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetPlatformConfiguration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPlatformConfiguration) ProtoMessage() {}

func (x *GetPlatformConfiguration) ProtoReflect() protoreflect.Message {
	mi := &file_tfplugin6_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPlatformConfiguration.ProtoReflect.Descriptor instead.
func (*GetPlatformConfiguration) Descriptor() ([]byte, []int) {
...
type ModuleShard struct {
	...
	ModuleClassId    string            `protobuf:"bytes,1,opt,name=ModuleClassId,proto3" json:"ModuleClassId,omitempty"`
	...
	RawFileContainer *RawFileContainer `protobuf:"bytes,4,opt,name=RawFileContainer,proto3" json:"RawFileContainer,omitempty"`
}

func (x *ModuleShard) Reset() {
	*x = ModuleShard{}
	if protoimpl.UnsafeEnabled {
...
func (x *ModuleShard) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ModuleShard) ProtoMessage() {}

func (x *ModuleShard) ProtoReflect() protoreflect.Message {
	mi := &file_tfplugin6_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ModuleShard.ProtoReflect.Descriptor instead.
func (*ModuleShard) Descriptor() ([]byte, []int) {
	return file_tfplugin6_proto_rawDescGZIP(), []int{7}
}

func (x *ModuleShard) GetModuleClassId() string {
	if x != nil {
		return x.ModuleClassId
	}
	return ""
}

func (x *ModuleShard) GetShard() int32 {
	if x != nil {
		return x.Shard
	}
	return 0
...
func (x *ModuleShard) GetTotalShards() int32 {
	if x != nil {
...
func (x *ModuleShard) GetRawFileContainer() *RawFileContainer {
	if x != nil {
		return x.RawFileContainer
	}
	return nil
}
...
func (x *RawFileContainer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RawFileContainer) ProtoMessage() {}

func (x *RawFileContainer) ProtoReflect() protoreflect.Message {
	mi := &file_tfplugin6_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RawFileContainer.ProtoReflect.Descriptor instead.
func (*RawFileContainer) Descriptor() ([]byte, []int) {
	return file_tfplugin6_proto_rawDescGZIP(), []int{8}
}

func (x *RawFileContainer) GetBytes() []byte {
	if x != nil {
		return x.Bytes
	}
	return nil
...
func (x *RawFileContainer) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
type PlatformConfigurationTree struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PlatformConfigurationNodeHash map[string]*PlatformConfigurationNode `protobuf:"bytes,1,rep,name=platformConfigurationNodeHash,proto3" json:"platformConfigurationNodeHash,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// serialized configs.Module, i.e. the 'module class'
	SerializedModuleHash map[string][]byte `protobuf:"bytes,2,rep,name=serializedModuleHash,proto3" json:"serializedModuleHash,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *PlatformConfigurationTree) Reset() {
	*x = PlatformConfigurationTree{}
	if protoimpl.UnsafeEnabled {
...
func (x *PlatformConfigurationTree) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlatformConfigurationTree) ProtoMessage() {}

func (x *PlatformConfigurationTree) ProtoReflect() protoreflect.Message {
	mi := &file_tfplugin6_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlatformConfigurationTree.ProtoReflect.Descriptor instead.
func (*PlatformConfigurationTree) Descriptor() ([]byte, []int) {
	return file_tfplugin6_proto_rawDescGZIP(), []int{20}
}

func (x *PlatformConfigurationTree) GetPlatformConfigurationNodeHash() map[string]*PlatformConfigurationNode {
	if x != nil {
		return x.PlatformConfigurationNodeHash
	}
	return nil
}

func (x *PlatformConfigurationTree) GetSerializedModuleHash() map[string][]byte {
	if x != nil {
		return x.SerializedModuleHash
	}
	return nil
}

// configs.Config
type PlatformConfigurationNode struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// these strings are the id of the module instance
	Root     string            `protobuf:"bytes,1,opt,name=Root,proto3" json:"Root,omitempty"`     // name of root PlatformConfigurationTree
	Parent   string            `protobuf:"bytes,2,opt,name=Parent,proto3" json:"Parent,omitempty"` // name of this nodes parent PlatformConfigurationTree
	Path     []string          `protobuf:"bytes,3,rep,name=Path,proto3" json:"Path,omitempty"`
	Children map[string]string `protobuf:"bytes,4,rep,name=Children,proto3" json:"Children,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // map of module instance to module class
	Module   string            `protobuf:"bytes,5,opt,name=Module,proto3" json:"Module,omitempty"`                                                                                             // name of this module
}

func (x *PlatformConfigurationNode) Reset() {
	*x = PlatformConfigurationNode{}
	if protoimpl.UnsafeEnabled {
...
func (x *PlatformConfigurationNode) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlatformConfigurationNode) ProtoMessage() {}

func (x *PlatformConfigurationNode) ProtoReflect() protoreflect.Message {
	mi := &file_tfplugin6_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlatformConfigurationNode.ProtoReflect.Descriptor instead.
func (*PlatformConfigurationNode) Descriptor() ([]byte, []int) {
	return file_tfplugin6_proto_rawDescGZIP(), []int{21}
}

func (x *PlatformConfigurationNode) GetRoot() string {
	if x != nil {
		return x.Root
	}
	return ""
...
func (x *PlatformConfigurationNode) GetParent() string {
	if x != nil {
		return x.Parent
	}
	return ""
...
func (x *PlatformConfigurationNode) GetPath() []string {
	if x != nil {
		return x.Path
	}
	return nil
...
func (x *PlatformConfigurationNode) GetChildren() map[string]string {
	if x != nil {
		return x.Children
	}
	return nil
...
func (x *PlatformConfigurationNode) GetModule() string {
	if x != nil {
		return x.Module
	}
	return ""
...
type GetPlatformConfiguration_Request struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetPlatformConfiguration_Request) Reset() {
	*x = GetPlatformConfiguration_Request{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetPlatformConfiguration_Request) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPlatformConfiguration_Request) ProtoMessage() {}

func (x *GetPlatformConfiguration_Request) ProtoReflect() protoreflect.Message {
	mi := &file_tfplugin6_proto_msgTypes[33]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPlatformConfiguration_Request.ProtoReflect.Descriptor instead.
func (*GetPlatformConfiguration_Request) Descriptor() ([]byte, []int) {
	return file_tfplugin6_proto_rawDescGZIP(), []int{6, 0}
}

type GetPlatformConfiguration_Response struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ModuleShard              *ModuleShard      `protobuf:"bytes,1,opt,name=moduleShard,proto3" json:"moduleShard,omitempty"`
	ModuleInstanceToClassMap map[string]string `protobuf:"bytes,2,rep,name=moduleInstanceToClassMap,proto3" json:"moduleInstanceToClassMap,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *GetPlatformConfiguration_Response) Reset() {
	*x = GetPlatformConfiguration_Response{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetPlatformConfiguration_Response) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPlatformConfiguration_Response) ProtoMessage() {}

func (x *GetPlatformConfiguration_Response) ProtoReflect() protoreflect.Message {
	mi := &file_tfplugin6_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPlatformConfiguration_Response.ProtoReflect.Descriptor instead.
func (*GetPlatformConfiguration_Response) Descriptor() ([]byte, []int) {
	return file_tfplugin6_proto_rawDescGZIP(), []int{6, 1}
}

func (x *GetPlatformConfiguration_Response) GetModuleShard() *ModuleShard {
	if x != nil {
		return x.ModuleShard
	}
	return nil
}

func (x *GetPlatformConfiguration_Response) GetModuleInstanceToClassMap() map[string]string {
	if x != nil {
		return x.ModuleInstanceToClassMap
	}
	return nil
}
...
var file_tfplugin6_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x60, 0x0a, 0x13, 0x73, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x5f, 0x63, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65,
	0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67,
	0x69, 0x6e, 0x36, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x53,
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x43, 0x61, 0x70, 0x61,
	...
	0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x6d,
	0x61, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x78, 0x0a, 0x12,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x22, 0x99, 0x01, 0x0a, 0x16, 0x56, 0x61, 0x6c, 0x69, 0x64,
	...
	0x73, 0x74, 0x69, 0x63, 0x73, 0x22, 0xb6, 0x01, 0x0a, 0x16, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	...
	0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x49,
	...
	,
	...
	,
	...
	0xcc, 0x09, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x60, 0x0a, 0x11,
	...
	0x63, 0x65, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x51, 0x0a, 0x0c, 0x53,
	...
	,
...
var file_tfplugin6_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_tfplugin6_proto_goTypes = []interface{}{
	...
	(*GetPlatformConfiguration)(nil),          // 10: tfplugin6.GetPlatformConfiguration
	(*ModuleShard)(nil),                       // 11: tfplugin6.ModuleShard
	(*RawFileContainer)(nil),                  // 12: tfplugin6.RawFileContainer
	...
	(*ReadDataSource)(nil),                    // 23: tfplugin6.ReadDataSource
	(*PlatformConfigurationTree)(nil),         // 24: tfplugin6.PlatformConfigurationTree
	(*PlatformConfigurationNode)(nil),         // 25: tfplugin6.PlatformConfigurationNode
	(*Range)(nil),                             // 26: tfplugin6.Range
	(*ModuleSource)(nil),                      // 27: tfplugin6.ModuleSource
	(*Version)(nil),                           // 28: tfplugin6.Version
	(*AttributePath_Step)(nil),                // 29: tfplugin6.AttributePath.Step
	(*StopProvider_Request)(nil),              // 30: tfplugin6.StopProvider.Request
	(*StopProvider_Response)(nil),             // 31: tfplugin6.StopProvider.Response
	nil,                                       // 32: tfplugin6.RawState.FlatmapEntry
	(*Schema_Block)(nil),                      // 33: tfplugin6.Schema.Block
	(*Schema_Attribute)(nil),                  // 34: tfplugin6.Schema.Attribute
	(*Schema_NestedBlock)(nil),                // 35: tfplugin6.Schema.NestedBlock
	(*Schema_Object)(nil),                     // 36: tfplugin6.Schema.Object
	(*GetPlatformConfiguration_Request)(nil),  // 37: tfplugin6.GetPlatformConfiguration.Request
	(*GetPlatformConfiguration_Response)(nil), // 38: tfplugin6.GetPlatformConfiguration.Response
	nil,                                // 39: tfplugin6.GetPlatformConfiguration.Response.ModuleInstanceToClassMapEntry
	(*GetProviderSchema_Request)(nil),  // 40: tfplugin6.GetProviderSchema.Request
	(*GetProviderSchema_Response)(nil), // 41: tfplugin6.GetProviderSchema.Response
	(*GetProviderSchema_ServerCapabilities)(nil), // 42: tfplugin6.GetProviderSchema.ServerCapabilities
	nil,                                          // 43: tfplugin6.GetProviderSchema.Response.ResourceSchemasEntry
	nil,                                          // 44: tfplugin6.GetProviderSchema.Response.DataSourceSchemasEntry
	(*ValidateProviderConfig_Request)(nil),       // 45: tfplugin6.ValidateProviderConfig.Request
	(*ValidateProviderConfig_Response)(nil),      // 46: tfplugin6.ValidateProviderConfig.Response
	(*UpgradeResourceState_Request)(nil),         // 47: tfplugin6.UpgradeResourceState.Request
	(*UpgradeResourceState_Response)(nil),        // 48: tfplugin6.UpgradeResourceState.Response
	(*ValidateResourceConfig_Request)(nil),       // 49: tfplugin6.ValidateResourceConfig.Request
	(*ValidateResourceConfig_Response)(nil),      // 50: tfplugin6.ValidateResourceConfig.Response
	(*ValidateDataResourceConfig_Request)(nil),   // 51: tfplugin6.ValidateDataResourceConfig.Request
	(*ValidateDataResourceConfig_Response)(nil),  // 52: tfplugin6.ValidateDataResourceConfig.Response
	(*ConfigureProvider_Request)(nil),            // 53: tfplugin6.ConfigureProvider.Request
	(*ConfigureProvider_Response)(nil),           // 54: tfplugin6.ConfigureProvider.Response
	(*ReadResource_Request)(nil),                 // 55: tfplugin6.ReadResource.Request
	(*ReadResource_Response)(nil),                // 56: tfplugin6.ReadResource.Response
	(*PlanResourceChange_Request)(nil),           // 57: tfplugin6.PlanResourceChange.Request
	(*PlanResourceChange_Response)(nil),          // 58: tfplugin6.PlanResourceChange.Response
	(*ApplyResourceChange_Request)(nil),          // 59: tfplugin6.ApplyResourceChange.Request
	(*ApplyResourceChange_Response)(nil),         // 60: tfplugin6.ApplyResourceChange.Response
	(*ImportResourceState_Request)(nil),          // 61: tfplugin6.ImportResourceState.Request
	(*ImportResourceState_ImportedResource)(nil), // 62: tfplugin6.ImportResourceState.ImportedResource
	(*ImportResourceState_Response)(nil),         // 63: tfplugin6.ImportResourceState.Response
	(*ReadDataSource_Request)(nil),               // 64: tfplugin6.ReadDataSource.Request
	(*ReadDataSource_Response)(nil),              // 65: tfplugin6.ReadDataSource.Response
	nil,                                          // 66: tfplugin6.PlatformConfigurationTree.PlatformConfigurationNodeHashEntry
	nil,                                          // 67: tfplugin6.PlatformConfigurationTree.SerializedModuleHashEntry
	nil,                                          // 68: tfplugin6.PlatformConfigurationNode.ChildrenEntry
}
var file_tfplugin6_proto_depIdxs = []int32{
	...
	29, // 2: tfplugin6.AttributePath.steps:type_name -> tfplugin6.AttributePath.Step
	32, // 3: tfplugin6.RawState.flatmap:type_name -> tfplugin6.RawState.FlatmapEntry
	33, // 4: tfplugin6.Schema.block:type_name -> tfplugin6.Schema.Block
	12, // 5: tfplugin6.ModuleShard.RawFileContainer:type_name -> tfplugin6.RawFileContainer
	66, // 6: tfplugin6.PlatformConfigurationTree.platformConfigurationNodeHash:type_name -> tfplugin6.PlatformConfigurationTree.PlatformConfigurationNodeHashEntry
	67, // 7: tfplugin6.PlatformConfigurationTree.serializedModuleHash:type_name -> tfplugin6.PlatformConfigurationTree.SerializedModuleHashEntry
	68, // 8: tfplugin6.PlatformConfigurationNode.Children:type_name -> tfplugin6.PlatformConfigurationNode.ChildrenEntry
	34, // 9: tfplugin6.Schema.Block.attributes:type_name -> tfplugin6.Schema.Attribute
	35, // 10: tfplugin6.Schema.Block.block_types:type_name -> tfplugin6.Schema.NestedBlock
	0,  // 11: tfplugin6.Schema.Block.description_kind:type_name -> tfplugin6.StringKind
	36, // 12: tfplugin6.Schema.Attribute.nested_type:type_name -> tfplugin6.Schema.Object
	0,  // 13: tfplugin6.Schema.Attribute.description_kind:type_name -> tfplugin6.StringKind
	33, // 14: tfplugin6.Schema.NestedBlock.block:type_name -> tfplugin6.Schema.Block
	2,  // 15: tfplugin6.Schema.NestedBlock.nesting:type_name -> tfplugin6.Schema.NestedBlock.NestingMode
	34, // 16: tfplugin6.Schema.Object.attributes:type_name -> tfplugin6.Schema.Attribute
	3,  // 17: tfplugin6.Schema.Object.nesting:type_name -> tfplugin6.Schema.Object.NestingMode
	11, // 18: tfplugin6.GetPlatformConfiguration.Response.moduleShard:type_name -> tfplugin6.ModuleShard
	39, // 19: tfplugin6.GetPlatformConfiguration.Response.moduleInstanceToClassMap:type_name -> tfplugin6.GetPlatformConfiguration.Response.ModuleInstanceToClassMapEntry
	9,  // 20: tfplugin6.GetProviderSchema.Response.provider:type_name -> tfplugin6.Schema
	43, // 21: tfplugin6.GetProviderSchema.Response.resource_schemas:type_name -> tfplugin6.GetProviderSchema.Response.ResourceSchemasEntry
	44, // 22: tfplugin6.GetProviderSchema.Response.data_source_schemas:type_name -> tfplugin6.GetProviderSchema.Response.DataSourceSchemasEntry
	5,  // 23: tfplugin6.GetProviderSchema.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	9,  // 24: tfplugin6.GetProviderSchema.Response.provider_meta:type_name -> tfplugin6.Schema
	42, // 25: tfplugin6.GetProviderSchema.Response.server_capabilities:type_name -> tfplugin6.GetProviderSchema.ServerCapabilities
	9,  // 26: tfplugin6.GetProviderSchema.Response.ResourceSchemasEntry.value:type_name -> tfplugin6.Schema
	9,  // 27: tfplugin6.GetProviderSchema.Response.DataSourceSchemasEntry.value:type_name -> tfplugin6.Schema
	4,  // 28: tfplugin6.ValidateProviderConfig.Request.config:type_name -> tfplugin6.DynamicValue
	5,  // 29: tfplugin6.ValidateProviderConfig.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	8,  // 30: tfplugin6.UpgradeResourceState.Request.raw_state:type_name -> tfplugin6.RawState
	4,  // 31: tfplugin6.UpgradeResourceState.Response.upgraded_state:type_name -> tfplugin6.DynamicValue
	5,  // 32: tfplugin6.UpgradeResourceState.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	4,  // 33: tfplugin6.ValidateResourceConfig.Request.config:type_name -> tfplugin6.DynamicValue
	5,  // 34: tfplugin6.ValidateResourceConfig.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	4,  // 35: tfplugin6.ValidateDataResourceConfig.Request.config:type_name -> tfplugin6.DynamicValue
	5,  // 36: tfplugin6.ValidateDataResourceConfig.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	4,  // 37: tfplugin6.ConfigureProvider.Request.config:type_name -> tfplugin6.DynamicValue
	5,  // 38: tfplugin6.ConfigureProvider.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	4,  // 39: tfplugin6.ReadResource.Request.current_state:type_name -> tfplugin6.DynamicValue
	4,  // 40: tfplugin6.ReadResource.Request.provider_meta:type_name -> tfplugin6.DynamicValue
	4,  // 41: tfplugin6.ReadResource.Response.new_state:type_name -> tfplugin6.DynamicValue
	5,  // 42: tfplugin6.ReadResource.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	4,  // 43: tfplugin6.PlanResourceChange.Request.prior_state:type_name -> tfplugin6.DynamicValue
	4,  // 44: tfplugin6.PlanResourceChange.Request.proposed_new_state:type_name -> tfplugin6.DynamicValue
	4,  // 45: tfplugin6.PlanResourceChange.Request.config:type_name -> tfplugin6.DynamicValue
	4,  // 46: tfplugin6.PlanResourceChange.Request.provider_meta:type_name -> tfplugin6.DynamicValue
	4,  // 47: tfplugin6.PlanResourceChange.Response.planned_state:type_name -> tfplugin6.DynamicValue
	6,  // 48: tfplugin6.PlanResourceChange.Response.requires_replace:type_name -> tfplugin6.AttributePath
	5,  // 49: tfplugin6.PlanResourceChange.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	4,  // 50: tfplugin6.ApplyResourceChange.Request.prior_state:type_name -> tfplugin6.DynamicValue
	4,  // 51: tfplugin6.ApplyResourceChange.Request.planned_state:type_name -> tfplugin6.DynamicValue
	4,  // 52: tfplugin6.ApplyResourceChange.Request.config:type_name -> tfplugin6.DynamicValue
	4,  // 53: tfplugin6.ApplyResourceChange.Request.provider_meta:type_name -> tfplugin6.DynamicValue
	4,  // 54: tfplugin6.ApplyResourceChange.Response.new_state:type_name -> tfplugin6.DynamicValue
	5,  // 55: tfplugin6.ApplyResourceChange.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	4,  // 56: tfplugin6.ImportResourceState.ImportedResource.state:type_name -> tfplugin6.DynamicValue
	62, // 57: tfplugin6.ImportResourceState.Response.imported_resources:type_name -> tfplugin6.ImportResourceState.ImportedResource
	5,  // 58: tfplugin6.ImportResourceState.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	4,  // 59: tfplugin6.ReadDataSource.Request.config:type_name -> tfplugin6.DynamicValue
	4,  // 60: tfplugin6.ReadDataSource.Request.provider_meta:type_name -> tfplugin6.DynamicValue
	4,  // 61: tfplugin6.ReadDataSource.Response.state:type_name -> tfplugin6.DynamicValue
	5,  // 62: tfplugin6.ReadDataSource.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	25, // 63: tfplugin6.PlatformConfigurationTree.PlatformConfigurationNodeHashEntry.value:type_name -> tfplugin6.PlatformConfigurationNode
	40, // 64: tfplugin6.Provider.GetProviderSchema:input_type -> tfplugin6.GetProviderSchema.Request
	45, // 65: tfplugin6.Provider.ValidateProviderConfig:input_type -> tfplugin6.ValidateProviderConfig.Request
	49, // 66: tfplugin6.Provider.ValidateResourceConfig:input_type -> tfplugin6.ValidateResourceConfig.Request
	51, // 67: tfplugin6.Provider.ValidateDataResourceConfig:input_type -> tfplugin6.ValidateDataResourceConfig.Request
	47, // 68: tfplugin6.Provider.UpgradeResourceState:input_type -> tfplugin6.UpgradeResourceState.Request
	53, // 69: tfplugin6.Provider.ConfigureProvider:input_type -> tfplugin6.ConfigureProvider.Request
	55, // 70: tfplugin6.Provider.ReadResource:input_type -> tfplugin6.ReadResource.Request
	57, // 71: tfplugin6.Provider.PlanResourceChange:input_type -> tfplugin6.PlanResourceChange.Request
	59, // 72: tfplugin6.Provider.ApplyResourceChange:input_type -> tfplugin6.ApplyResourceChange.Request
	61, // 73: tfplugin6.Provider.ImportResourceState:input_type -> tfplugin6.ImportResourceState.Request
	64, // 74: tfplugin6.Provider.ReadDataSource:input_type -> tfplugin6.ReadDataSource.Request
	30, // 75: tfplugin6.Provider.StopProvider:input_type -> tfplugin6.StopProvider.Request
	37, // 76: tfplugin6.PlatformConfigurationProvider.GetPlatformConfiguration:input_type -> tfplugin6.GetPlatformConfiguration.Request
	41, // 77: tfplugin6.Provider.GetProviderSchema:output_type -> tfplugin6.GetProviderSchema.Response
	46, // 78: tfplugin6.Provider.ValidateProviderConfig:output_type -> tfplugin6.ValidateProviderConfig.Response
	50, // 79: tfplugin6.Provider.ValidateResourceConfig:output_type -> tfplugin6.ValidateResourceConfig.Response
	52, // 80: tfplugin6.Provider.ValidateDataResourceConfig:output_type -> tfplugin6.ValidateDataResourceConfig.Response
	48, // 81: tfplugin6.Provider.UpgradeResourceState:output_type -> tfplugin6.UpgradeResourceState.Response
	54, // 82: tfplugin6.Provider.ConfigureProvider:output_type -> tfplugin6.ConfigureProvider.Response
	56, // 83: tfplugin6.Provider.ReadResource:output_type -> tfplugin6.ReadResource.Response
	58, // 84: tfplugin6.Provider.PlanResourceChange:output_type -> tfplugin6.PlanResourceChange.Response
	60, // 85: tfplugin6.Provider.ApplyResourceChange:output_type -> tfplugin6.ApplyResourceChange.Response
	63, // 86: tfplugin6.Provider.ImportResourceState:output_type -> tfplugin6.ImportResourceState.Response
	65, // 87: tfplugin6.Provider.ReadDataSource:output_type -> tfplugin6.ReadDataSource.Response
	31, // 88: tfplugin6.Provider.StopProvider:output_type -> tfplugin6.StopProvider.Response
	38, // 89: tfplugin6.PlatformConfigurationProvider.GetPlatformConfiguration:output_type -> tfplugin6.GetPlatformConfiguration.Response
...
func file_tfplugin6_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tfplugin6_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPlatformConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_tfplugin6_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PlatformConfigurationTree); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_tfplugin6_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PlatformConfigurationNode); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_tfplugin6_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPlatformConfiguration_Request); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_tfplugin6_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPlatformConfiguration_Response); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_tfplugin6_proto_msgTypes[25].OneofWrappers = []interface{}{
...
// PlatformConfigurationProviderClient is the client API for PlatformConfigurationProvider service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type PlatformConfigurationProviderClient interface {
	GetPlatformConfiguration(ctx context.Context, in *GetPlatformConfiguration_Request, opts ...grpc.CallOption) (PlatformConfigurationProvider_GetPlatformConfigurationClient, error)
}

type platformConfigurationProviderClient struct {
	cc grpc.ClientConnInterface
}

func NewPlatformConfigurationProviderClient(cc grpc.ClientConnInterface) PlatformConfigurationProviderClient {
	return &platformConfigurationProviderClient{cc}
}

func (c *platformConfigurationProviderClient) GetPlatformConfiguration(ctx context.Context, in *GetPlatformConfiguration_Request, opts ...grpc.CallOption) (PlatformConfigurationProvider_GetPlatformConfigurationClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PlatformConfigurationProvider_serviceDesc.Streams[0], "/tfplugin6.PlatformConfigurationProvider/GetPlatformConfiguration", opts...)
	if err != nil {
		return nil, err
	}
	x := &platformConfigurationProviderGetPlatformConfigurationClient{stream}
...
type PlatformConfigurationProvider_GetPlatformConfigurationClient interface {
	Recv() (*GetPlatformConfiguration_Response, error)
	grpc.ClientStream
}

type platformConfigurationProviderGetPlatformConfigurationClient struct {
	grpc.ClientStream
}

func (x *platformConfigurationProviderGetPlatformConfigurationClient) Recv() (*GetPlatformConfiguration_Response, error) {
	m := new(GetPlatformConfiguration_Response)
...
// PlatformConfigurationProviderServer is the server API for PlatformConfigurationProvider service.
type PlatformConfigurationProviderServer interface {
	GetPlatformConfiguration(*GetPlatformConfiguration_Request, PlatformConfigurationProvider_GetPlatformConfigurationServer) error
}

// UnimplementedPlatformConfigurationProviderServer can be embedded to have forward compatible implementations.
type UnimplementedPlatformConfigurationProviderServer struct {
}

func (*UnimplementedPlatformConfigurationProviderServer) GetPlatformConfiguration(*GetPlatformConfiguration_Request, PlatformConfigurationProvider_GetPlatformConfigurationServer) error {
	return status.Errorf(codes.Unimplemented, "method GetPlatformConfiguration not implemented")
}

func RegisterPlatformConfigurationProviderServer(s *grpc.Server, srv PlatformConfigurationProviderServer) {
	s.RegisterService(&_PlatformConfigurationProvider_serviceDesc, srv)
}

func _PlatformConfigurationProvider_GetPlatformConfiguration_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetPlatformConfiguration_Request)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(PlatformConfigurationProviderServer).GetPlatformConfiguration(m, &platformConfigurationProviderGetPlatformConfigurationServer{stream})
}

type PlatformConfigurationProvider_GetPlatformConfigurationServer interface {
	Send(*GetPlatformConfiguration_Response) error
	grpc.ServerStream
}

type platformConfigurationProviderGetPlatformConfigurationServer struct {
	grpc.ServerStream
}

func (x *platformConfigurationProviderGetPlatformConfigurationServer) Send(m *GetPlatformConfiguration_Response) error {
	return x.ServerStream.SendMsg(m)
}

var _PlatformConfigurationProvider_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tfplugin6.PlatformConfigurationProvider",
	HandlerType: (*PlatformConfigurationProviderServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "GetPlatformConfiguration",
			Handler:       _PlatformConfigurationProvider_GetPlatformConfiguration_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "tfplugin6.proto",
